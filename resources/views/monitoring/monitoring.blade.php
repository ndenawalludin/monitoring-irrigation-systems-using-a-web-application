		...
		<div class="container-fluid">
			<div class="row bg-title">
				<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
					<h4 class="page-title">Monitoring tanaman</h4>
				</div>
				...
				<div class="col-md-12 col-lg-12 col-sm-12">
					<div class="white-box">
						...
						<thead>
							...
							<th scope="col" style="text-align:center">Durasi penyiraman</th>
							</tr>
						</thead>
						<tbody>
							@foreach($pelanggars as $p)
								<tr>
									...
									<td style="text-align:center">{{ $p->temperature}} ⁰C</td>
									<td style="text-align:center">{{ $p->kelembaban}} %</td>
									
									<?php if ($p->defuzzy == 1) : ?>
									<td style="text-align:center">Mati</td>
								
									<?php elseif ($p->defuzzy == 2) : ?>
										<td style="text-align:center">4 S</td>
									
									<?php elseif ($p->defuzzy == 3) : ?>
										<td style="text-align:center">7 S</td>
									
									<?php elseif ($p->defuzzy == 4) : ?>
										<td style="text-align:center">9 S</td>
									
									<?php elseif ($p->defuzzy == 5) : ?>
						...
						<ul class="pagination pull-right">
							<li class="active">{{ $pelanggars->links() }}</a></li>
                        </ul>
